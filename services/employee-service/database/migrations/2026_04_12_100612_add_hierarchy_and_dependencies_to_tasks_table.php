...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('tasks', function (Blueprint $table) {
            $table->uuid('parent_task_id')->nullable()->after('mission_id');
            $table->uuid('dependency_task_id')->nullable()->after('parent_task_id');
    ...
    public function down(): void
    {
        Schema::table('tasks', function (Blueprint $table) {
            ...
            $table->dropColumn(['parent_task_id', 'dependency_task_id']);
        });
    }
};
